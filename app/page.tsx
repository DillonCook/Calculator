            ...
            <div className="grid gap-3 md:grid-cols-[minmax(0,1fr)_auto] md:items-start">
              <div className="min-w-0 max-w-3xl">
                <h1 className="text-2xl font-semibold md:text-3xl" aria-label="DealCooker">
                  <span className="brandAurora" role="text">
                    {Array.from('DealCooker').map((letter, index) => (
                      <span key={`${letter}-${index}`} className="brandAuroraLetter" style={{ ['--letter-index' as string]: index }}>
                        {letter}
                      </span>
                    ))}
                  </span>
